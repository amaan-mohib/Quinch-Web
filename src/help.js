...
export default function Help() {
    return(
        <div className="help quicksand">
            <p>
                There are 10 questions throughout the quiz.<br/>
                Each question carries 10 points, so a total of 100 points can be scored.
            </p>
            <p>
                For help there are four lifelines unlocked at certain levels of the quiz,
                with an increase in the allotted time of +10 seconds at those levels.<br/>
            ...
            <table>
                ...
                <tr>
                    <td style={{'width':'30%', 'paddingLeft':'8%'}}><Lifeline option="50 : 50"/></td>
                    <td>This is '50 : 50'.<br/>On using it, out of the four given options, two wrong options get vanished.</td>
                </tr>
                <tr>
                    <td style={{'width':'30%', 'paddingLeft':'8%'}}><Lifeline option={<SearchIcon className="iconSpacer2"/>}/></td>
                    <td>This is 'Search the Web'.<br/>On using it one can search the question on the internet.</td>
                </tr>
                <tr>
...
function Lifeline(props){
    return(
        <button disabled className="lifelineBtn">
            {props.option}
        </button>
    );
}